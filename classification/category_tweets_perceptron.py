...
initialModelAP.load("perceptronModels.json",average=False)
...
loadModelOP.load("perceptronModels.json",average=False)
...
loadModelAP.load("perceptronModels.json",average=False)
